...
if __name__ == "__main__":
    ...
    backbone = resnet_fpn_backbone('resnet50', pretrained=False, norm_layer=None, trainable_layers=5)
    model = OrientedRCNN(backbone, cfg)
    ...
    for k, v in out["rpn_out"].items():
        ...
        loss += rpn_loss(anchors[k], v["anchor_offsets"], v["objectness_scores"], ground_truth["boxes"])
