...
def visualize_rpn_predictions(
    ...
    for k, stride in zip(rpn_out.region_proposals.keys(), fpn_strides):
        curr_image = image.copy()
        proposals = rpn_out.region_proposals[k][0]
        objectness = rpn_out.objectness_scores[k][0]
...
if __name__ == "__main__":
    ...
    with profile(
        ...
        for e in range(epochs):
            ...
            total_loss = out.rpn_output.loss.total_loss
            ...
            out.rpn_output.loss.to_writer(writer, f"rpn", e)
