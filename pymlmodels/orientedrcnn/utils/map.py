...
import numpy as np
import torch
from ..ops.rotated_iou import pairwise_iou_rotated
...
def rotated_map(det_results,
    ...
    for i in range(num_classes):
        ...
        for d, g, i, iou, area in zip(cls_dets, cls_gts, cls_gts_ignore, [iou_thr for _ in range(num_imgs)], [area_ranges for _ in range(num_imgs)]):
            res = tpfp_default(d, g, i, iou, area)
            tp.append(res[0])
            fp.append(res[1])
